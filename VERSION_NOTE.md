...
- v1.1.7: Portfolio-ready GitHub pass — professional README (badges, structure, recruiter section), MIT LICENSE, docs/ (PORTFOLIO case study, SCREENSHOTS guide); package.json repository/homepage/keywords; in-app readiness/exam disclaimers (scores are estimates, not CompTIA guarantees); dynamic save-hint on Manage view (device vs browser); softened "book the exam" verdict copy.
